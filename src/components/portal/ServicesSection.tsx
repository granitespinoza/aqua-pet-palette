...
const ServicesSection = () => {
  ...
  return (
    <section id="servicios" className="py-20 bg-gradient-to-br from-white via-neutral-50 to-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container-professional relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto stagger-children">
          {services.map((service, index) => (
            <div 
              key={service.title} 
              className="card-professional p-8 text-center group hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 bg-white/80 backdrop-blur-sm animate-fade-up" 
              style={{
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-primary/10 to-catshop-500/10 text-primary border border-primary/20">
            <span className="text-sm font-medium">¿Necesitas más información? Escribenos al correo ❤️</span>
          </div>
        </div>
      </div>
    </section>
