...
const TenantSelector = () => {
  ...
  return (
    <section id="tiendas" className="py-20 bg-gradient-to-br from-neutral-50 to-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container-professional relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto stagger-children">
          {tenants.map((tenant, index) => (
            <div key={tenant.tenantId} className="animate-fade-up" style={{
