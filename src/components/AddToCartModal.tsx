      ...
      <DialogContent className="modal-glass max-w-md border-gray-200 shadow-2xl bg-slate-400">
        ...
        <div className="space-y-6">
          <div className="flex items-center space-x-4 p-4 bg-white/60 rounded-lg border border-gray-200">
            <img src={product.img} alt={product.nombre} className="w-16 h-16 object-cover rounded-lg border border-gray-200 shadow-sm" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center space-x-4 p-4 bg-white/60 rounded-lg border border-gray-200">
              <Button variant="outline" size="sm" onClick={decrementQuantity} disabled={quantity <= 1} className="w-10 h-10 rounded-full border-gray-300 hover:bg-gray-100 hover:border-gray-400 disabled:opacity-50">
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
            <Button variant="outline" onClick={() => onOpenChange(false)} className="px-6 py-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 bg-white">
              Cancelar
            </Button>
            <Button onClick={handleAddToCart} className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-md">
              Agregar al carrito
            </Button>
          </div>
        </div>
