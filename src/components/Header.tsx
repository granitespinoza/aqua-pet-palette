...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-lime-bright/10 to-yellow-bright/10 border-b border-lime-bright/20 watercolor-section">
        <div className="container mx-auto px-4 py-2">
          <div className="flex justify-between items-center text-sm">
            <div className="text-white font-bold pet-glow-lime flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-4 text-white font-medium">
              ...
              {!user && (
                <Button
                  ...
                  className="text-white hover:text-black hover:bg-lime-bright/80 pet-button-glow font-bold"
                >
      ...
      {/* Main Header */}
      <header className={`bg-dark-light/95 backdrop-blur-sm border-b border-lime-bright/30 sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <div className="w-12 h-12 bg-gradient-to-br from-lime-bright to-yellow-bright rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-lg">
            ...
            <div className="flex items-center space-x-2">
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="hidden md:flex pet-button-glow text-white font-bold">
                      <User className="w-4 h-4 mr-2 pet-icon-interactive" />
                      <span className="pet-icon-interactive mr-1">👤</span> {user.profile.nombre}
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align="end" className="bg-dark-light/95 backdrop-blur-sm border-2 border-lime-bright/30 shadow-xl">
                    <DropdownMenuItem onClick={logout} className="pet-link-glow text-white hover:text-black">
                ...
                <Button variant="ghost" size="sm" className="hidden md:flex pet-button-glow text-white font-bold" onClick={handleAuthClick}>
                  <User className="w-4 h-4 mr-2 pet-icon-interactive" />
                  <span className="pet-icon-interactive mr-1">👤</span>
                  Mi cuenta
                </Button>
              ...
              <CartDrawer />
              <Button variant="ghost" size="sm" className="md:hidden pet-button-glow text-white">
        ...
        {/* Navigation Menu */}
        <nav className="bg-dark-light/95 backdrop-blur-sm border-t border-lime-bright/20">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-center md:justify-start space-x-1 py-3 overflow-x-auto">
              <Link 
                ...
                className="whitespace-nowrap px-4 py-2 text-sm font-bold text-white hover:text-black hover:bg-lime-bright/80 rounded-lg transition-colors pet-link-glow pet-button-glow"
              >
              ...
              <Link 
                ...
                className="whitespace-nowrap px-4 py-2 text-sm font-bold text-white hover:text-black hover:bg-yellow-bright/80 rounded-lg transition-colors font-bold pet-link-glow pet-button-glow pet-glow-yellow"
              >
                <span className="pet-icon-interactive mr-1">🔥</span>
                Liquidación
